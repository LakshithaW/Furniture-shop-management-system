...
public class mainDelivery extends javax.swing.JFrame {

    /**
     * Creates new form mainDelivery
     */
    public mainDelivery() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jButton2.setText("Vehicle Rates");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(mainDelivery.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new mainDelivery().setVisible(true);
            }
        });
    }
